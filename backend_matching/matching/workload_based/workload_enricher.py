...
class OccupationWorkloadEnricher:
    ...
    def __init__(
        ...
        employed_person_csv_path: str | Path = _DEFAULT_ILOSTAT_DIR / "HOW_TEMP_SEX_OC2_NB_A.csv",
        employee_csv_path: str | Path = _DEFAULT_ILOSTAT_DIR / "HOW_XEES_SEX_OC2_NB_A.csv",
    ) -> None:
