...
class InformalityEnricher:
    ...
    def __init__(
        ...
        occupation_rate_csv_path: str | Path = _DEFAULT_ILOSTAT_DIR / "EMP_NIFL_SEX_OC2_RT_A.csv",
        occupation_rate_major_csv_path: str | Path = _DEFAULT_ILOSTAT_DIR / "EMP_NIFL_SEX_OCU_RT_A.csv",
        # optional sector fallback for sparse countries
        sector_primary_csv_path: str | Path = _DEFAULT_ILOSTAT_DIR / "SDG_0831_SEX_ECO_RT.csv",
        sector_fallback_csv_path: str | Path = _DEFAULT_ILOSTAT_DIR / "SDG_B831_SEX_ECO_RT.csv",
    ) -> None:
