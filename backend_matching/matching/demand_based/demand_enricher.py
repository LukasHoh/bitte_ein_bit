...
class OccupationDemandEnricher:
    ...
    def __init__(
        ...
        occupation_level_2_csv_path: str | Path = "backend_matching/data/ilostat/EMP_TEMP_SEX_OC2_NB_A.csv",
        occupation_major_csv_path: str | Path = "backend_matching/data/ilostat/EMP_TEMP_SEX_OCU_NB_A.csv",
    ) -> None:
